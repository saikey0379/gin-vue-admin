...
export const findPromYamlListByClusterId = (params) => {
  return service({
    url: '/prometheusCluster/findPromYamlListByClusterId',
    method: 'get',
    params
  })
}

export const findPromYamlDetailByClusterId = (params) => {
  return service({
    url: '/prometheusCluster/findPromYamlDetailByClusterId',
    method: 'get',
    params
  })
}

export const findPromYamlDetailCurrentByClusterId = (params) => {
  return service({
    url: '/prometheusCluster/findPromYamlDetailCurrentByClusterId',
    method: 'get',
    params
  })
}

export const diffPromYamlByClusterId = (params) => {
  return service({
    url: '/prometheusCluster/diffPromYamlByClusterId',
    method: 'get',
    params
  })
}

export const updatePrometheusRulesByClusterId = (params) => {
  return service({
    url: '/prometheusCluster/updatePrometheusRulesByClusterId',
    method: 'put',
    params
  })
}