...
// DeleteIdcCabinetByIds 批量删除数据中心机柜记录
// Author [piexlmax](https://github.com/piexlmax)
...
// GetIdcCabinetInfoList 分页获取数据中心机柜记录
// Author [piexlmax](https://github.com/piexlmax)
