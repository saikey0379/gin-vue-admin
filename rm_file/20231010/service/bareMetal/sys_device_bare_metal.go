...
func (bmService *BareMetalService) CreateBareMetal(bm *bareMetal.BareMetal) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (bmService *BareMetalService)DeleteBareMetal(bm bareMetal.BareMetal) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (bmService *BareMetalService)UpdateBareMetal(bm bareMetal.BareMetal) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (bmService *BareMetalService)GetBareMetal(id uint) (bm bareMetal.BareMetal, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (bmService *BareMetalService)GetBareMetalInfoList(info bareMetalReq.BareMetalSearch) (list []bareMetal.BareMetal, total int64, err error) {
	limit := info.PageSize
	offset := info.PageSize * (info.Page - 1)
    // 创建db
	db := global.GVA_DB.Model(&bareMetal.BareMetal{})
    var bms []bareMetal.BareMetal
    // 如果有条件搜索 下方会自动创建搜索语句
