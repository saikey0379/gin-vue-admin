...
// 数据中心业务网段 结构体  IdcIpService1
type IdcIpService1 struct {
      global.GVA_MODEL
...
// TableName 数据中心业务网段 IdcIpService1自定义表名 idc_ip_service1
func (IdcIpService1) TableName() string {
  return "idc_ip_service1"
}
