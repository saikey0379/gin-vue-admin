...
// 数据中心 结构体  DataCenterIpManage
type DataCenterIpManage struct {
      global.GVA_MODEL
...
// TableName 数据中心 DataCenterIpManage自定义表名 data_center_ip_manage
func (DataCenterIpManage) TableName() string {
  return "data_center_ip_manage"
}
