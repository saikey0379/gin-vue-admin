...
// 数据中心 结构体  DataCenterIpService
type DataCenterIpService struct {
      global.GVA_MODEL
...
// TableName 数据中心 DataCenterIpService自定义表名 data_center_ip_service
func (DataCenterIpService) TableName() string {
  return "data_center_ip_service"
}
