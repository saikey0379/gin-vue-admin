...
func (ksService *ConfigKickstartService) CreateConfigKickstart(ks *osInstall.ConfigKickstart) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (ksService *ConfigKickstartService) DeleteConfigKickstart(ks osInstall.ConfigKickstart) (err error) {
...
func (ksService *ConfigKickstartService) DeleteConfigKickstartByIds(ids request.IdsReq) (err error) {
	err = global.GVA_DB.Delete(&[]osInstall.ConfigKickstart{}, "id in ?", ids.Ids).Error
	return err
}

// UpdateConfigKickstart 更新Kickstart配置记录
// Author [piexlmax](https://github.com/piexlmax)
func (ksService *ConfigKickstartService) UpdateConfigKickstart(ks osInstall.ConfigKickstart) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (ksService *ConfigKickstartService) GetConfigKickstart(id uint) (ks osInstall.ConfigKickstart, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (ksService *ConfigKickstartService) GetConfigKickstartInfoList(info osInstallReq.ConfigKickstartSearch) (list []osInstall.ConfigKickstart, total int64, err error) {
	limit := info.PageSize
	offset := info.PageSize * (info.Page - 1)
	// 创建db
	db := global.GVA_DB.Model(&osInstall.ConfigKickstart{})
	var kss []osInstall.ConfigKickstart
	// 如果有条件搜索 下方会自动创建搜索语句
