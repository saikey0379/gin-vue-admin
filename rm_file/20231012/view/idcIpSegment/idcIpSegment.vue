<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="掩码" prop="netmask" width="120" />
        <el-table-column align="left" label="网关" prop="gateway" width="120" />
        <el-table-column sortable align="left" label="机房" prop="idcId" width="120" />
        <el-table-column align="left" label="网段类型" prop="ipSegmentType" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.ipSegmentType,ipSegmentTypeOptions) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="VLAN" prop="vlanId" width="120" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" :title="type==='create'?'添加':'修改'" destroy-on-close>
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="机房:"  prop="idcId" >
              <el-input v-model.number="formData.idcId" :clearable="false" placeholder="请输入机房" />
            </el-form-item>
            <el-form-item label="网段类型:"  prop="ipSegmentType" >
              <el-select v-model="formData.ipSegmentType" placeholder="请选择网段类型" style="width:100%" :clearable="true" >
    ...
    <el-dialog v-model="detailShow" style="width: 800px" lock-scroll :before-close="closeDetailShow" title="查看详情" destroy-on-close>
      <el-scrollbar height="550px">
        <el-descriptions column="1" border>
                ...
                <el-descriptions-item label="网段类型">
