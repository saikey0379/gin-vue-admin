...
// @Param data body model.ServerDiscovery true "创建Server发现"
...
// @accept application/json
// @Produce application/json
// @Param data body model.ServerDiscovery true "删除Server发现"
...
// @accept application/json
// @Produce application/json
// @Param data body model.ServerDiscovery true "更新Server发现"
...
// @accept application/json
// @Produce application/json
// @Param data query model.ServerDiscovery true "用id查询Server发现"
