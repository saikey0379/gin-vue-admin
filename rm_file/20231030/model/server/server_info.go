...
type ServerInfo struct {
	...
	Cpu          string `json:"cpu" form:"cpu" gorm:"column:cpu;comment:CPU信息;size:4;"`                                //CPU信息
	MemorySum    *int   `json:"memorySum" form:"memorySum" gorm:"column:memory_sum;comment:内存汇总;size:16;"`             //内存
	Memory       string `json:"memory" form:"memory" gorm:"column:memory;comment:内存信息;size:4;"`                        //内存信息
...
// TableName ServerInfo ServerInfo自定义表名 server_info
