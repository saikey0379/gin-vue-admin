...
// CreateServerDiscovery 创建Server发现记录
...
// DeleteServerDiscovery 删除Server发现记录
// Author [piexlmax](https://github.com/piexlmax)
...
// DeleteServerDiscoveryByIds 批量删除Server发现记录
// Author [piexlmax](https://github.com/piexlmax)
...
// UpdateServerDiscovery 更新Server发现记录
// Author [piexlmax](https://github.com/piexlmax)
...
// GetServerDiscovery 根据id获取Server发现记录
// Author [piexlmax](https://github.com/piexlmax)
...
// GetServerDiscoveryInfoList 分页获取Server发现记录
// Author [piexlmax](https://github.com/piexlmax)
