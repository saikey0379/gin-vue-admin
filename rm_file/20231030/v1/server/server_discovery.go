...
// CreateServerDiscovery 创建Server发现
// @Tags ServerDiscovery
// @Summary 创建Server发现
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body server.ServerDiscovery true "创建Server发现"
...
// DeleteServerDiscovery 删除Server发现
// @Tags ServerDiscovery
// @Summary 删除Server发现
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body server.ServerDiscovery true "删除Server发现"
...
// DeleteServerDiscoveryByIds 批量删除Server发现
// @Tags ServerDiscovery
...
// UpdateServerDiscovery 更新Server发现
// @Tags ServerDiscovery
// @Summary 更新Server发现
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data body server.ServerDiscovery true "更新Server发现"
...
// FindServerDiscovery 用id查询Server发现
// @Tags ServerDiscovery
// @Summary 用id查询Server发现
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query server.ServerDiscovery true "用id查询Server发现"
...
// GetServerDiscoveryList 分页获取Server发现列表
// @Tags ServerDiscovery
// @Summary 分页获取Server发现列表
// @Security ApiKeyAuth
// @accept application/json
// @Produce application/json
// @Param data query serverReq.ServerDiscoverySearch true "分页获取Server发现列表"
