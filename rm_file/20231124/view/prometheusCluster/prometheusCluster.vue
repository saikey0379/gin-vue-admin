<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="用户名" prop="sshUser" width="120" />
        <el-table-column align="left" label="RSA" prop="sshRsa" width="120" />
        <el-table-column align="left" label="节点" prop="nodes" width="120" />
        <el-table-column align="left" label="配置路径" prop="pathConf" width="120" />
