...
var bmService = service.ServiceGroupApp.AssetServiceGroup.BareMetalService
...
// @accept application/json
// @Produce application/json
// @Param data body asset.BareMetal true "删除裸金属设备"
...
// @accept application/json
// @Produce application/json
// @Param data body asset.BareMetal true "更新裸金属设备"
...
// @accept application/json
// @Produce application/json
// @Param data query asset.BareMetal true "用id查询裸金属设备"
...
// @accept application/json
// @Produce application/json
// @Param data query assetReq.BareMetalSearch true "分页获取裸金属设备列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /bm/getBareMetalList [get]
func (bmApi *BareMetalApi) GetBareMetalList(c *gin.Context) {
	var pageInfo assetReq.BareMetalSearch
