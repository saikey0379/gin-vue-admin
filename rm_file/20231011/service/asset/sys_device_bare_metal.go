...
func (bmService *BareMetalService) CreateBareMetal(bm *asset.BareMetal) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (bmService *BareMetalService)DeleteBareMetal(bm asset.BareMetal) (err error) {
...
func (bmService *BareMetalService)DeleteBareMetalByIds(ids request.IdsReq) (err error) {
	err = global.GVA_DB.Delete(&[]asset.BareMetal{},"id in ?",ids.Ids).Error
	return err
}

// UpdateBareMetal 更新裸金属设备记录
// Author [piexlmax](https://github.com/piexlmax)
func (bmService *BareMetalService)UpdateBareMetal(bm asset.BareMetal) (err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (bmService *BareMetalService)GetBareMetal(id uint) (bm asset.BareMetal, err error) {
...
// Author [piexlmax](https://github.com/piexlmax)
func (bmService *BareMetalService)GetBareMetalInfoList(info assetReq.BareMetalSearch) (list []asset.BareMetal, total int64, err error) {
	limit := info.PageSize
	offset := info.PageSize * (info.Page - 1)
    // 创建db
	db := global.GVA_DB.Model(&asset.BareMetal{})
    var bms []asset.BareMetal
    // 如果有条件搜索 下方会自动创建搜索语句
