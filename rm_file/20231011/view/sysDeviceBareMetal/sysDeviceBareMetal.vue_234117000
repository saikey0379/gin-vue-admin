  ...
  <div>
    <div class="gva-search-box">
      ...
      <el-date-picker v-model="searchInfo.endCreatedAt" type="datetime" placeholder="结束日期" :disabled-date="time=> searchInfo.startCreatedAt ? time.getTime() < searchInfo.startCreatedAt.getTime() : false"></el-date-picker>
        ...
        <el-form-item label="描述" prop="device_describe">
    ...
    <div class="gva-table-box">
        ...
        <el-table-column sortable align="left" label="业务网络" prop="network_id" width="120" />
        <el-table-column sortable align="left" label="管理IP" prop="manage_ip" width="120" />
        <el-table-column sortable align="left" label="管理网络" prop="manage_network_id" width="120" />
        <el-table-column sortable align="left" label="硬件配置" prop="hardware_id" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.hardware_id,intOptions) }}
            </template>
        </el-table-column>
        <el-table-column sortable align="left" label="系统" prop="kickstart_id" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.kickstart_id,intOptions) }}
            </template>
        </el-table-column>
        <el-table-column sortable align="left" label="机柜" prop="cabinet_id" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.cabinet_id,intOptions) }}
            </template>
        </el-table-column>
        <el-table-column sortable align="left" label="U位" prop="cabinet_u" width="120" />
        ...
        <el-table-column sortable align="left" label="标签" prop="label_id" width="120">
            <template #default="scope">
            {{ filterDict(scope.row.label_id,intOptions) }}
            </template>
        </el-table-column>
        <el-table-column align="left" label="描述" prop="device_describe" width="120" />
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" :title="type==='create'?'添加':'修改'" destroy-on-close>
      <el-scrollbar height="500px">
          <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
            ...
            <el-form-item label="业务IP:"  prop="ip" >
              <el-input v-model="formData.ip" :clearable="false"  placeholder="请输入业务IP" />
            </el-form-item>
            <el-form-item label="业务网络:"  prop="network_id" >
              <el-input v-model.number="formData.network_id" :clearable="false" placeholder="请输入业务网络" />
            </el-form-item>
            <el-form-item label="管理IP:"  prop="manage_ip" >
              <el-input v-model="formData.manage_ip" :clearable="false"  placeholder="请输入管理IP" />
            </el-form-item>
            <el-form-item label="管理网络:"  prop="manage_network_id" >
              <el-input v-model.number="formData.manage_network_id" :clearable="false" placeholder="请输入管理网络" />
            </el-form-item>
            <el-form-item label="硬件配置:"  prop="hardware_id" >
              <el-select v-model="formData.hardware_id" placeholder="请选择硬件配置" style="width:100%" :clearable="false" >
                <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
              </el-select>
            </el-form-item>
            <el-form-item label="系统:"  prop="kickstart_id" >
              <el-select v-model="formData.kickstart_id" placeholder="请选择系统" style="width:100%" :clearable="false" >
                <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
              </el-select>
            </el-form-item>
            <el-form-item label="机柜:"  prop="cabinet_id" >
              <el-select v-model="formData.cabinet_id" placeholder="请选择机柜" style="width:100%" :clearable="false" >
                <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
              </el-select>
            </el-form-item>
            <el-form-item label="U位:"  prop="cabinet_u" >
            ...
            <el-form-item label="开发:"  prop="manager_dev" >
              <el-input v-model="formData.manager_dev" :clearable="false"  placeholder="请输入开发" />
            </el-form-item>
            <el-form-item label="运维:"  prop="manager_ops" >
              <el-input v-model="formData.manager_ops" :clearable="false"  placeholder="请输入运维" />
            </el-form-item>
            <el-form-item label="标签:"  prop="label_id" >
              <el-select v-model="formData.label_id" placeholder="请选择标签" style="width:100%" :clearable="false" >
                <el-option v-for="(item,key) in intOptions" :key="key" :label="item.label" :value="item.value" />
              </el-select>
            </el-form-item>
            <el-form-item label="描述:"  prop="device_describe" >
              <el-input v-model="formData.device_describe" :clearable="false"  placeholder="请输入描述" />
            </el-form-item>
          </el-form>
      </el-scrollbar>
      <template #footer>
